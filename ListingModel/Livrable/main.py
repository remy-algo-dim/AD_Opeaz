...
if __name__ == '__main__':
	...
	df, dic, table_data = pipeline(args.file, pp=False, api=True, df_info=False, api_key=api_key)
	...
	while len(dic) == 0:
	    ...
	    df, dic, _ = pipeline(filename, pp=False, api=False, df_info=table_data[next_table], api_key=api_key)
	    next_table += 1
